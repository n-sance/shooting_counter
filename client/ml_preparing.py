...
train_dataset = tf.data.Dataset.from_generator(
    data_generator, output_types=(tf.float32, tf.int32), output_shapes=((2), (1))  # nb
)
...
model = Sequential(
    [Input(shape=(2)), Dense(5, activation="relu"), Dense(1, activation="sigmoid")]
)
...
test_X = np.array([[300, 500], [0.3, 0.4], [12, 90000], [0.7, 0.2]])
